...
#line default
#line hidden
public static System.Web.WebPages.HelperResult Grid(HtmlHelper htmlHelper, GridOptions options)
{
#line default
#line hidden
return new System.Web.WebPages.HelperResult(__razor_helper_writer => {
...
WriteTo(__razor_helper_writer, htmlHelper.Form().ItemsPerPageDropdown(options.Pagination == null ? (int?)null : options.Pagination.ItemsPerPage));
...
WriteTo(__razor_helper_writer, htmlHelper.RenderHtmlAttributes(options.TableHtmlAttributes));
...
WriteTo(__razor_helper_writer, options.FormControls(null));
...
WriteTo(__razor_helper_writer, htmlHelper.Paginator(options.Pagination, action: options.Action, controller: options.Controller));
