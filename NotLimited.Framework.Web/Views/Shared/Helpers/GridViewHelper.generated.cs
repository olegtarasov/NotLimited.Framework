...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 3754), Tuple.Create("\"", 3801)
, Tuple.Create(Tuple.Create("", 3762), Tuple.Create("fa", 3762), true)
, Tuple.Create(Tuple.Create(" ", 3764), Tuple.Create<System.Object, System.Int32>(TableHelpers.GetSortIcon(sortOrder)
, 3765), false)
);
