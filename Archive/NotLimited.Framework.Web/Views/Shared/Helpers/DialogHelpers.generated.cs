...
#line default
#line hidden
public static System.Web.WebPages.HelperResult ModalDialog(string id, string title, Func<object, HelperResult> body, Func<IDisposable> form, string okHandler, string okText, string cancelText, bool forceSubmit)
{
#line default
#line hidden
...
WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\"", 391), Tuple.Create("\"", 399)
, Tuple.Create(Tuple.Create("", 396), Tuple.Create<System.Object, System.Int32>(id
, 396), false)
);
...
WriteAttributeTo(__razor_helper_writer, "onclick", Tuple.Create(" onclick=\"", 1379), Tuple.Create("\"", 1399)
                        , Tuple.Create(Tuple.Create("", 1389), Tuple.Create<System.Object, System.Int32>(okHandler
, 1389), false)
);
